...
export default function SectionHeader({ eyebrow, title, description, align = 'center' }) {
  return (
    ...
    >
      {eyebrow && (
        <p className="mb-4 text-xs font-semibold uppercase tracking-[0.35em] text-sky-300/90">
          {eyebrow}
        </p>
      )}
      <h2 className="font-display text-4xl font-semibold tracking-[-0.04em] text-white md:text-6xl">
        {title}
      </h2>
      {description && (
